...
RAW_BASE="${X_MILI_RAW_BASE:-https://raw.githubusercontent.com/${REPO_SLUG}/main}"
...
panel_needs_initialization() {
    ...
    [[ -z "${info}" ]] && return 0
    echo "${info}" | grep -Eq "bootstrapPending: true|hasDefaultCredential: true"
}
...
CONTAINER="ml_app"
RAW_INSTALL="${X_MILI_RAW_BASE:-https://raw.githubusercontent.com/2019563552abc/X-MILI/main}/install-docker.sh"
